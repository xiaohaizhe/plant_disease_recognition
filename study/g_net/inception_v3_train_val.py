...
def step_train(train_op,loss,accuracy,
    ...
    with tf.Session() as sess:
        ...
        for i in range(max_steps + 1):
            ...
            print("step into train test loop---")
...
def train(train_record_file,
    ...
    with slim.arg_scope(v3.inception_v3_arg_scope()):
        out, end_points = v3.inception_v3(inputs=input_images, num_classes=labels_nums, dropout_keep_prob=keep_prob, is_training=is_training)
...
if __name__ == '__main__':
    train_record_file='record/train.tfrecords'
    val_record_file='record/val.tfrecords'
